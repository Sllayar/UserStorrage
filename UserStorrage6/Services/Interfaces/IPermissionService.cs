...
namespace UserStorrage6.Services.Interfaces
{
    public interface IPermissionService
    {
        ...
        //Task<List<Permission>?> Synhronize(List<PermissionShort>? Permissions, Service service, DateTime currentdate, DateTime syncTime);
    ...
    public interface IPermissionBrockerService
    {
        ...
        Task<List<Permission>?> Synhronize(IDataBrocker dataBrocker, List<PermissionShort>? Permissions, Service service, DateTime currentdate, DateTime syncTime);
